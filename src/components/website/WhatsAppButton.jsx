...
function WhatsAppButton() {
    ...
    return (
        <a
            ...
            className="fixed bottom-24 sm:bottom-6 right-4 sm:right-6 z-50 flex items-center gap-3 bg-[#25D366] hover:bg-[#20BA5A] text-white px-5 py-3 rounded-full shadow-2xl transition-all duration-300 ease-in-out transform hover:scale-105 group"
